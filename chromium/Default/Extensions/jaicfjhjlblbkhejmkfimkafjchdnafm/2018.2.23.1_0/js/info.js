...
chrome.permissions.getAll(function(permissions) {
	...
	for (var permission of permissions.permissions) {
		...
		switch(permission) {
		case 'activeTab':
			setDesc('#permissions-api-values', permission, 'Mandatory Permission. Allows the extension to modify the contents of http://kissanime.ru/ if it is open in a Tab.');
			break;
		case 'downloads':
		...
		case 'webRequestBlocking':
			setDesc('#permissions-api-values', permission, 'Mandatory Permission. Used to Block Ad Domains that originate from http://kissanime.ru/.');
			break;
		}
